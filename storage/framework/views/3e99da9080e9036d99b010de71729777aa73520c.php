...
<script>
  ...
  const submitStockChanges = (e) => {
    ...
    $ui.toggleButtonLoading($('#js-stok-produk-form'));
      ...
      stockStore.updateStock(payload)
        .then(res => {
          ...
          if (res.status == 200) {
            ...
            $helper.resetForm($('#js-stok-produk-form'));
            $ui.toggleButtonLoading($('#js-stok-produk-form'), false);
          }
        })
    } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/fit-iduka.com/ptviduka_pos/resources/views/produk/stok.blade.php ENDPATH**/ ?>