                    ...
                    <div class="card-body">
                        <select class="form-control" id="select-kasir" onchange="selectKasir();">
                            ...
                            <?php $__currentLoopData = $kasir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->kasir_id); ?>"><?php echo e($item->nama_kasir); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/izharauliataqwa/Documents/project/idukafix/resources/views/report/kasir.blade.php ENDPATH**/ ?>