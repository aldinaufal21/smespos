                    ...
                    <div class="card-body">
                        <select class="form-control" id="select-cabang" onchange="selectCabang();">
                            ...
                            <?php $__currentLoopData = $cabang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->cabang_id); ?>"><?php echo e($item->nama_cabang); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/izharauliataqwa/Documents/project/idukafix/resources/views/kasir_umkm/kasir.blade.php ENDPATH**/ ?>