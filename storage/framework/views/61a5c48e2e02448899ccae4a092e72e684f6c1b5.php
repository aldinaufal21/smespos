        ...
        <div class="minicart-inner-content" id="mini-cart-content">
            ...
            <div class="minicart-content-box" v-if="token && cart.length">
                ...
                <div class="minicart-button">
                    <a href="<?php echo e(route('konsumen.cart')); ?>"><i class="fa fa-shopping-cart"></i> view cart</a>
            ...
            <div class="minicart-content-box" v-if="!token">
              ...
              <br><br>
              <div class="minicart-button">
                <a href="<?php echo e(route('konsumen.login')); ?>"><i class="fa fa-sign-in"></i> Login</a>
                <center>or</center>
                <a href="<?php echo e(route('konsumen.register')); ?>"><i class="fa fa-user-plus"></i> Register</a>
              </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/izharauliataqwa/Documents/project/idukafix/resources/views/konsumen_app/layouts/partials/mini-cart.blade.php ENDPATH**/ ?>