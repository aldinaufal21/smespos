                    ...
                    <div class="card-body">
                        <select class="form-control" id="select-cabang" onchange="selectCabang();">
                            <?php $__currentLoopData = $cabang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($id_cabang === $item->cabang_id): ?> selected <?php endif; ?> value="<?php echo e($item->cabang_id); ?>"><?php echo e($item->nama_cabang); ?></option>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form role="form" id="js-filter-form" action="<?php echo e(route('kasir_umkm.kasir_result')); ?>" method="POST">
                            ...
                            <input type="hidden" name="id_cabang" value="<?php echo e($id_cabang); ?>" id="form-cabang-id" class="form-control">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form role="form" id="js-filter-form" action="<?php echo e(route('kasir_umkm.kasir_result')); ?>" method="POST">
                            ...
                            <input type="hidden" name="id_cabang" value="<?php echo e($id_cabang); ?>" id="form-cabang-id-2" class="form-control">
                            <div class="input-group mb-3">
                            <div class="row mb-3">
