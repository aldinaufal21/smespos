      ...
      <div class="row">
        ...
        <div class="col-lg-7">
          <div class="p-5">
            ...
            <hr>
            <div class="text-center">
              <a class="small" href="<?php echo e(route('login')); ?>">Sudah memiliki akun? Login!</a>
            </div>
          </div>
        </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/fit-iduka.com/ptviduka_pos/resources/views/auth/register.blade.php ENDPATH**/ ?>