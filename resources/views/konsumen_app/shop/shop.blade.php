      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="list-group">
            <a :href="`{{ route('konsumen.produk') }}?cabang=${cabang.cabang_id}`" class="list-group-item list-group-item-action" v-for="cabang in cabangs" :key="cabang.cabang_id"><b>@{{ cabang.nama_cabang }}</b> <br> @{{ cabang.alamat_cabang }}</a>
          </div>
        </div>
      </div>
    </div>
