        ...
        <div class="row">
            <div class="col">
                <div class="card shadow mb-4">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Pilih Kasir</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
...
<script>
  $auth.needRole(['cabang']);

  $moment.locale('id');
  let tableDailyTransaction = null;
  let user = $auth.userCredentials();
  let _idCabang = user.cabang.cabang_id;
  let _idKasir = null;

  function selectKasir(){
    let _idKasir = $("#select-kasir").val();
